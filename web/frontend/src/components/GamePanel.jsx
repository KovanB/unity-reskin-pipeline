    ...
    <div style={{ position: "relative", width: "100%", height: "100%", background: "#000", borderRadius: 16, overflow: "hidden" }}>
      ...
      <div style={{
        ...
        <div style={{ fontSize: 13, color: "#6b6b80", textAlign: "center", maxWidth: 300 }}>
          Unity WebGL game loads here. Build the game in Unity Editor and place files in <code style={{ color: "#7c5cfc" }}>/unity/Build/</code>
        </div>
        <div style={{ fontSize: 11, color: "#444", marginTop: 8 }}>
          Meanwhile, you can still customize textures using the panel
        </div>
      </div>
